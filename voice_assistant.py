...
# VOICE_ACTIVITY_THRESHOLD = 15.0 # RMS % to trigger STT
...
#             log(LogLevel.INFO, "Returning to wake word detection")
#             self.state = State.IDLE
#             self._last_status_log = 0.0
#             return
...
#         """
#         Flush stale audio buffer, then enter 5-minute ACTIVE_COMMAND mode.
